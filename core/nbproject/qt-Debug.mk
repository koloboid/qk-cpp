...
# Generated by qmake (3.0) (Qt 5.1.1) on: ?? ????. 19 08:38:48 2013
...
dist: 
	@test -d build/Debug/GNU-Linux-x86/core1.0.0 || mkdir -p build/Debug/GNU-Linux-x86/core1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/core1.0.0/ && $(COPY_FILE) --parents blob.hpp blockqueue.hpp config.hpp consoledevice.hpp core.export.hpp enum.hpp enumitem.hpp error.hpp lock.hpp log.hpp logger.hpp loggertextio.hpp logitem.hpp loglevel.hpp timespan.hpp valref.hpp build/Debug/GNU-Linux-x86/core1.0.0/ && $(COPY_FILE) --parents config.cpp consoledevice.cpp enum.cpp enumitem.cpp error.cpp lock.cpp log.cpp log.glibc.cpp logger.cpp loggertextio.cpp logitem.cpp loglevel.cpp timespan.cpp build/Debug/GNU-Linux-x86/core1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/core1.0.0` && $(TAR) core1.0.0.tar core1.0.0 && $(COMPRESS) core1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/core1.0.0`/core1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/core1.0.0
